  ...
  <div class="Login" v-on:keyup.enter="auth">
    <md-toolbar class="md-primary" md-elevation="1">
      <div class="md-toolbar-row md-toolbar-offset">
        <div class="md-toolbar-section-start">
          <h1 class="md-title" style="flex: 1">RedEx</h1>
        </div>
        <div class="md-toolbar-section-end">
          <md-button class="md-primary">Login</md-button>
          <md-button class="md-primary">Registro</md-button>
        </div>
      </div>
    </md-toolbar>
    <div class="centered-container">
      <md-content class="md-elevation-3">
        ...
        <div class="title">
          <img src="../assets/img/logo-redex.png">
        ...
        <div class="warnings">
          <span style="color: red" v-if="authfailed">Usuario y/o contraseña incorrectos</span>
          <span style="color: red" v-if="emptyfields">Debes ingresar usuario y contraseña</span>
        </div>
  ...
  methods: {
    auth () {
      ...
      if (this.login.user !== '' && this.login.password !== '') {
        if (this.login.user === this.$store.state.testuser.user && this.login.password === this.$store.state.testuser.password) {
